...
<div class="x-body">
    <form class="layui-form"method="post" action="${pageContext.request.contextPath}/good" id="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="goodname" name="name" required="" lay-verify="required"
                       autocomplete="off" value="${good.name}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${good.price}" id="price" name="price" required=""
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${good.inventory}" id="inventory" name="inventory" required=""
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-text">
                <textarea id="description" name="description"
                          autocomplete="off" class="layui-textarea">${good.description}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
...
<script type="text/javascript">
    var editor = CKEDITOR.replace('description', {
            filebrowserUploadUrl : "${pageContext.request.contextPath}/updateItem?id=${good.id}",
